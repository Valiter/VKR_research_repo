...
keywords = [
    ...
    "коварств",    # коварство
    "вероломств",  # вероломство
    "манипуляц",   # манипуляция (уже есть, но повтор не страшен)
    "цинизм",
    "подкуп",
    "подлог",
    "мошеннич",
    ...
    "злокозн",
    "злонамерен",
    "жёстк",      # жёсткие манипуляции — корень "жёстк"
    "игнорир",    # игнорирование
    "эмоциональн",
    "притворств",  # притворство — корень "притвор" уже есть
    "ложь",        # уже есть
    "воровств",
    "подделк",
    "ухищр",
